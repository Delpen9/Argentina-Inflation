...
def get_currency_valuation_by_region(
    ...
    df_cpi["EU Currency Valuation"] = df_cpi["EU Yearly Inflation"][::-1].cumprod()[::-1]
    df_cpi["USA Currency Valuation"] = df_cpi["USA Yearly Inflation"][::-1].cumprod()[::-1]
    df_cpi["World Currency Valuation"] = df_cpi["World Yearly Inflation"][::-1].cumprod()[::-1]
